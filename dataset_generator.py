...
for [files, to_folder] in [[test_files, "./data/test/flowers"], [val_files, "./data/val/flowers"], [train_files, "./data/train/flowers"]]:
    k=0
...
for [files, to_folder] in [[test_files, "./data/test/sketches"], [val_files, "./data/val/sketches"], [train_files, "./data/train/sketches"]]:
    k=0
