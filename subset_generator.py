...
N_sample_train = 30 # will be multiplied by six after data augmentation
N_sample_val = 10
N_sample_test = 20 
...
# shorten the list : random sampling with the above defined number of images
test_files = random.sample(test_files, N_sample_test)
val_files = random.sample(val_files, N_sample_val)
train_files = random.sample(test_files, N_sample_train)
